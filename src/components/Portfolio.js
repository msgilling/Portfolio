        ...
        <div className="project-me">
          ...
          <div className="project-container">
            <div className="image-container">
              <Fade left>
                <img src={NIGHTDAZE} alt="nightdaze" className="nightdaze" width="700" />
              </Fade>
            </div>
            <Fade right>
              <div className="project-para">
                ...
                <div className="project-links">
                  <h4 className="readme"><button href="https://github.com/msgilling/SEI_Project-4/blob/main/README.md" className="readme-link"><FaGithub size={25} color="#dd8aa0" className="icon" />ReadMe</button></h4>
                  <h4 className="project"><button href="https://night-daze.herokuapp.com/" className="project-link"><HiLink size={25} color="#dd8aa0" className="icon" />Open Project</button></h4>
                </div>
              </div>
          ...
          <div className="project-container">
            <div className="image-container">
              <Fade left>
                <img src={PLATESTER} alt="nightdaze" className="nightdaze" width="700" />
              </Fade>
            </div>
            <Fade right>
              <div className="project-para">
                ...
                <div className="project-links">
                  <h4 className="readme"><button className="readme-link"><a href="https://github.com/msgilling/sei-project-3-platester/blob/master/README.md"><FaGithub size={25} color="#dd8aa0" className="icon" />ReadMe</a></button></h4>
                  <h4 className="project"><button className="project-link"><a href="https://platester.herokuapp.com/"><HiLink size={25} color="#dd8aa0" className="icon" />Open Project</a></button></h4>
                </div>
              </div>
            </Fade>
          </div>
          <div className="project-container">
            <div className="image-container">
              <Fade left>
                <img src={FILMOJO} alt="nightdaze" className="nightdaze" width="700" />
              </Fade>
            </div>
            <Fade right>
              <div className="project-para">
                ...
                <p>During a 48 hour Hackathon, myself and my partner pair-coded this movie app. <i>FILMOJO</i> uses the IMDB API to show the top 250 movies on the IMDB site. The user is able to browse the top movies, favourite them, and shuffle a random movie for inspiration.</p>
              </div>
            </Fade>
          </div>
        </div>
